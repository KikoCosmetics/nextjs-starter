...
import {KikAbstractControl as AbstractControl, ɵRawValue, ɵTypedOrUntyped, ɵValue} from "./kik-abstract-control.class";
...
/**
 * Tracks the value and validity state of an array of `KikFormControl`,
 * `FormGroup` or `FormArray` instances.
 *
 * A `FormArray` aggregates the values of each child `KikFormControl` into an array.
 ...
 * along with `KikFormControl`, `FormGroup`, and  `KikFormRecord`.
 *
 * @usageNotes
 *
 ...
 *   new KikFormControl('Nancy', Validators.minLength(2)),
 *   new KikFormControl('Drew'),
 * ]);
 *
 ...
 * @publicApi
 */
export class KikFormArray<TControl extends AbstractControl<any> = any> extends AbstractControl<
   ...
   * updateValueAndValidity} method.
    ...
    override setValue(value: ɵFormArrayRawValue<TControl>, options: {
        ...
        FNS.assertAllValuesPresent(this, false, value);
        value.forEach((newValue: any, index: number) => {
            FNS.assertControlPresent(this, false, index);
            this.at(index)
                .setValue(newValue, {
                    onlySelf: true,
                    emitEvent: options.emitEvent
 ...
 */
export type UntypedFormArray = KikFormArray<any>;

// eslint-disable-next-line @typescript-eslint/naming-convention
export const UntypedFormArray: UntypedFormArrayCtor = KikFormArray;
 ...
 */
// eslint-disable-next-line @typescript-eslint/naming-convention
export const isKikFormArray = (control: unknown): control is KikFormArray => control instanceof KikFormArray;
